...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {                             /*cualquiera podra ver las fotos*/      /*/images/**" cualquiera vera la foto por defecto*/
...
/*los mismos permisos para clientes/{id} y clietnes/uplaod porque al detalle se accede medientras el id del cliente*/
    ...
    public CorsConfigurationSource corsConfigurationSource(){
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:4200"));/*permitir el dominio*/
